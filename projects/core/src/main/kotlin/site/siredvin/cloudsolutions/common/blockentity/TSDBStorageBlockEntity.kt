...
class TSDBStorageBlockEntity(blockPos: BlockPos, blockState: BlockState) : PeripheralBlockEntity<TSDBStoragePeripheral>(ModBlockEntityTypes.TSDB_STORAGE.get(), blockPos, blockState) {
