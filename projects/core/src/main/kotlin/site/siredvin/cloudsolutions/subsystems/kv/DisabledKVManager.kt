...
object DisabledKVManager : KeyValueManager {
    override fun put(ownerUUID: String, key: String, value: String, expire: Instant?): MethodResult = throw LuaException("KV storage is disabled in server configuration")
    override fun mput(
        ownerUUID: String,
        values: Map<String, String>,
    ): MethodResult = throw LuaException("KV storage is disabled in server configuration")

    override fun delete(ownerUUID: String, key: String): MethodResult = throw LuaException("KV storage is disabled in server configuration")
    ...
    override fun putExpire(ownerUUID: String, key: String, expire: Instant?): MethodResult = throw LuaException("KV storage is disabled in server configuration")
